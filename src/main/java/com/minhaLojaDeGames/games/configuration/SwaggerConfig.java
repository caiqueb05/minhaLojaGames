package com.minhaLojaDeGames.games.configuration;
...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder().title("API - Loja de Games").description("Projeto API Spring - Loja de Games")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/caiqueb05")
				.contact(contact()).build();
	}

	private static Contact contact() {

		return new Contact("Caíque Bezerra", "https://github.com/caiqueb05/", "caique.bezerra@gmail.com");
